...
Public Class Rpt_Pegawai
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AplikasiTokoMurahRezeki.Rpt_Pegawai.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_Pegawai
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_Pegawai = New Rpt_Pegawai()
        rpt.Site = Me.Site
        Return rpt
    End Function
